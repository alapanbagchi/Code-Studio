<script lang="ts">
	...
	import AddPracticeProblems from '$lib/Forms/AddPracticeProblems.svelte';
	import { onMount } from 'svelte';
	import API from '../../../../../utils/API';
	import { page } from '$app/stores';
	let prefillData: any = undefined;
	onMount(async () => {
		const res = await API.get(`/problems/${$page.params.id}`);
...
{#if prefillData}
	<div class="container">
		<AddPracticeProblems preFilledData={prefillData} />
	</div>
{/if}
